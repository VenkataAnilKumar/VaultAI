    ...
    try {
      ...
      if (data.requiresConfirmation) {
        ...
        addMessage({
          ...
          model: data.workflow.steps?.[data.workflow.steps.length - 1]?.model,
      ...
      {!ollamaConnected && (
        <div className="bg-amber-50 border-b border-amber-200 px-4 py-2 flex items-center justify-between">
          <div className="flex items-center gap-2 text-amber-700 text-sm">
            ...
            <span>Ollama not running — start Ollama to enable AI features</span>
          </div>
        ...
        {showWelcome ? (
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center max-w-sm">
              ...
              <h2 className="text-base font-semibold text-gray-800 mb-1">Vault AI</h2>
              <p className="text-xs text-gray-400 mb-5">Ask about your files, or give instructions. All local.</p>
